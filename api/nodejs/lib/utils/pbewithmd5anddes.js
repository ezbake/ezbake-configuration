...
function pbewithmd5anddes(password) {
  ...
  this.salt = constants.DEFAULT_ENCRYPTION_SALT || "PLEASE SET A DEFAULT";
  this.saltSize = constants.DEFAULT_BYTES_FOR_SALT || 8;
  this.iterations = constants.DEFAULT_ENCRYPTION_ITERATIONS || 1000;
}
