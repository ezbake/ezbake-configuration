...
EzConfigurationLoader.prototype.isEzConfigurationLoader = true; //this is used to by ezConfiguration to determine it is a loader

EzConfigurationLoader.prototype._setProperty = function(key, value){
  if(key.indexOf('#') === 0) return; //line is a comment ignore it.
