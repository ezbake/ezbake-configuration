...
function DirectoryConfigurationLoader(directory){
  ...
  if(_.isString(directory)){
    ...
    this.dir = process.env[this.constants.EZCONFIGURATION_ENV_VAR] || this.constants.EZCONFIGURATION_DEFAULT_DIR;
  }
...
DirectoryConfigurationLoader.prototype.loadConfiguration = function(){
  ...
  var propFileRegex = new RegExp(_this.constants.PROPERTY_FILE_REGEX);
  var propertySplitRegex = new RegExp(_this.constants.SPLIT_ON_FIRST_EQUALS_REGEXP);
